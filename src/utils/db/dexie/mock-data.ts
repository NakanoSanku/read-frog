...
import { LLM_PROVIDER_TYPES } from "@/types/config/provider"
import { DEFAULT_LLM_PROVIDER_MODELS } from "@/utils/constants/providers"
...
export async function generateMockBatchRequestRecords(
  ...
  const records = Array.from({ length: count }, () => {
    ...
    return {
      ...
      provider,
      model: DEFAULT_LLM_PROVIDER_MODELS[provider].model,
    }
  })
