...
/**
 * Frozen v095 saved-word highlighting fixtures. The standard fixture series contains no
 * v1.47.0 gateway discriminators, so v093-to-v094 preserves it unchanged.
 * The v094-to-v095 migration adds the word highlighting preferences below.
 */
